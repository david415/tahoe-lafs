...
class Client(node.Node, pollmixin.PollMixin):
    ...
    def __init__(self, basedir="."):
        ...
        self.magicfolder_ready_d = defer.Deferred()
    ...
    def init_magic_folder(self):
        ...
        if self.get_config("magic_folder", "enabled", False, boolean=True):
            ...
            self.magicfolder_ready_d.addCallback(lambda x: s.ready())
            print "done initliazing magic-folders..."
